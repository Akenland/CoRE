 ...
 */
final class CoreCommands implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0 || args[0].equalsIgnoreCase("version")) {
            ...
            prompt.addAnswer("A roleplaying framework and server essentials, for survival and roleplay servers.", "");
            prompt.addAnswer("Website: https://plugins.akenland.com/", "url_https://plugins.akenland.com/");
        ...
        if (args[0].equalsIgnoreCase("reload")) {
            ...
            if (!sender.hasPermission("core.reload")) {
                Utils.notifyAdminsError(
                        sender.getName() + CommonColors.ERROR + " failed security check (reloading CoRE).");
