package com.kylenanakdewa.core.common.notifications;
...
/**
 * A Notification that can be sent to a CommandSender, alerting them of
...
public class Notification {
    ...
    public enum NotificationType {
        ...
        /** An error message. */
        ERROR(CommonColors.ERROR.getColor(), "An error has occurred", Sound.BLOCK_NOTE_BLOCK_BASS);
