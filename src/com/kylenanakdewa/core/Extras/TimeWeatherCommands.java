...
public final class TimeWeatherCommands implements TabExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(label.equalsIgnoreCase("sun")){
            if(!sender.hasPermission("core.time") || !sender.hasPermission("core.weather")) return Error.NO_PERMISSION.displayChat(sender);
        ...
        if(command.getName().equalsIgnoreCase("time")){
            // Check permission
            if(!sender.hasPermission("core.time")) return Error.NO_PERMISSION.displayChat(sender);
            ...
            if(args.length==0){
                ...
                prompt.addQuestion(CommonColors.INFO+"Current time: "+CommonColors.MESSAGE+getTimeString(world.getTime()));
        ...
        if(command.getName().equalsIgnoreCase("weather")){
            // Check permission
            if(!sender.hasPermission("core.weather")) return Error.NO_PERMISSION.displayChat(sender);
            ...
            if(args.length==0){
                ...
                prompt.addQuestion(conditions+CommonColors.INFO+" until "+getTimeString(world.getTime()+world.getWeatherDuration())+", about "+world.getWeatherDuration()/20+" seconds");
