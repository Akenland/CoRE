...
public final class WorldCommands implements TabExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(args.length>=2 && args[0].equalsIgnoreCase("create")){
            // Check permissions
            if(!sender.hasPermission("core.world.create") || !PermsUtils.isDoubleCheckedAdmin(sender)){
                Utils.notifyAdminsError(sender.getName()+CommonColors.ERROR+" failed security check (creating world "+String.join(" ", args)+").");
        ...
        if(args.length==2 && args[1].equalsIgnoreCase("load")){
            // Check permissions
            if(!sender.hasPermission("core.world.create") && !sender.hasPermission("core.world.load")) return Error.NO_PERMISSION.displayChat(sender);
        ...
        if(args.length==1){
            ...
            info.addQuestion(CommonColors.INFO+"--- "+CommonColors.MESSAGE+"World: "+color+world.getName()+CommonColors.INFO+" ---");
        ...
        if(args.length>=2 && args[1].equalsIgnoreCase("enter")){
            // Check permissions
            if(!sender.hasPermission("core.world.enter")) return Error.NO_PERMISSION.displayChat(sender);
	...
	public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if(args.length==1){
            ...
            if(sender.hasPermission("core.world.create")) completions.add("create");
