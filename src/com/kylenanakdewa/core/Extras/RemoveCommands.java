...
public final class RemoveCommands implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args){
        ...
        if(!sender.hasPermission("core.entity") || !PermsUtils.isDoubleCheckedAdmin(sender)){
            Utils.notifyAdminsError(sender.getName()+CommonColors.ERROR+" failed security check (removing entities "+String.join(" ", args)+").");
        ...
        if(!(args.length==3 && args[2].equalsIgnoreCase("confirm")) && (targetEntities.size()>200 || radius>100)){
            ...
            prompt.addAnswer(CommonColors.ERROR+"Remove "+targetEntities.size()+" entities", "command_remove "+arg+" "+radius+" confirm");
        ...
        sender.sendMessage(CommonColors.MESSAGE+"Removed "+entityCount+" entities.");
        return true;
    }
